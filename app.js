      ...
      h('div',{'data-cat':cat,'data-tid':task.id,draggable:reorderOn,
        ...
        h('div',{style:{flex:1,minWidth:0}},
          ...
          h('div',{style:{display:'flex',flexWrap:'wrap',gap:4,marginTop:1}},
            at&&h('span',{style:{fontSize:9,color:'#64748b'}},at),task.category==='event'&&h('span',{style:{fontSize:9,color:'#fb7185'}},'📅 '+((task.eventDates||[]).length>0?task.eventDates.join(', '):'Sin fecha')),task.project&&h('span',{style:{fontSize:9,color:'#475569'}},task.project))),
